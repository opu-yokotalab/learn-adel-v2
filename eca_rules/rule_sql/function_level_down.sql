-- Function as changeLv operation(down)
-- authed by Yutaka Konishi
-- 2006/10/25
CREATE FUNCTION level_down(integer,integer,integer) RETURNS void AS $$
  ...
  $action = `sh /home/learn/rails_app/adel_v2/teaching_materials/eca_rules/run.sh changeLv level,down $_[0] $_[1]`;
